        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={8} className="mx-auto text-center">
              ...
              >
                Valida tu dominio del inglés con
                <br />
                  ...
                  <Row>
                    <Col md={6}>
                      ...
                      >
                        ...
                        <div style={{ fontSize: "0.95rem" }}>
                          ...
                          <p style={{ margin: 0 }}>
                            <strong>Ideal:</strong> Trabajo en México
                          </p>
                        </div>
                      </div>
                    </Col>
                    <Col md={6}>
                      ...
                      >
                        ...
                        <div style={{ fontSize: "0.95rem" }}>
                          <p>
                            <strong>Enfoque:</strong> Académico
                          </p>
                          <p>
                            <strong>Validez:</strong> 5 años
                          </p>
                          <p>
                            <strong>Costo:</strong> Adicional
                          </p>
                          <p style={{ margin: 0 }}>
                            <strong>Ideal:</strong> Estudios/Internacional
                          </p>
                        </div>
                      </div>
                    </Col>
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 20px 60px rgba(0, 40, 104, 0.12)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "translateY(0)";
                  e.currentTarget.style.boxShadow =
                    "0 10px 40px rgba(0, 40, 104, 0.08)";
                }}
              >
                <div
                  style={{
              ...
              <Col md={6} lg={4} key={index}>
                <div
                  style={{
                    ...styles.levelCard,
                    borderColor:
                      activeLevel === level.id ? level.color : "transparent",
                    transform:
                      activeLevel === level.id ? "scale(1.05)" : "scale(1)",
                    boxShadow:
                ...
                >
                  ...
                  <p
                    style={{ color: "#6c757d", fontSize: "0.95rem", margin: 0 }}
                  >
                    {level.desc}
                  </p>
                </div>
                ...
                <div style={{ display: "flex", alignItems: "start" }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: "#6c757d", margin: 0 }}>
                      Certificaciones reconocidas por la Secretaría de Educación
                      Pública y aceptadas en todo el territorio nacional.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div style={{ display: "flex", alignItems: "start" }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: "#6c757d", margin: 0 }}>
                      98% de nuestros estudiantes obtienen su certificación en
                      el primer intento.
                    </p>
                  </div>
                </div>
