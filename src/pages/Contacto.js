...
import { 
  ...
  faUniversity, faShieldAlt, faHeadset, faUserGraduate,
  faComments, faCalendarAlt, faQuestionCircle, faPaperPlane,
  faCheckCircle, faInfoCircle, faGraduationCap, faCertificate
        ...
        <div style={styles.container}>
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <h1 style={{ 
              ...
              Contáctanos<br />
              <span style={{ color: '#f8fafc' }}>Estamos aquí para ayudarte</span>
            </h1>
            <p style={{ 
              fontSize: '1.3rem', 
              opacity: 0.9, 
              ...
              Resuelve todas tus dudas sobre nuestros programas académicos 
            ...
            {contactInfo.map((item, index) => (
              <div key={index} style={{ flex: '1', minWidth: '250px' }}>
                ...
                >
                  ...
                  <h5 style={{ color: '#002868', marginBottom: '10px' }}>{item.title}</h5>
                  <p style={{ 
                    fontWeight: '600', 
                    color: item.color, 
                    marginBottom: '8px',
              ...
              <div style={styles.academicCard}>
                ...
                <div onSubmit={handleSubmit} style={{ display: 'block' }}>
                  ...
                  <div style={styles.row}>
                    ...
                    <div style={styles.colHalf}>
                      <label style={styles.formLabel}>Servicio de interés</label>
                      <select
                        name="servicio"
            ...
            <div style={{ flex: '1', minWidth: '300px' }}>
              <div style={{ ...styles.academicCard, marginBottom: '30px' }}>
                <div style={{ textAlign: 'center', marginBottom: '25px' }}>
                  <FontAwesomeIcon icon={faQuestionCircle} style={{ fontSize: '3rem', color: '#BF0A30', marginBottom: '20px' }} />
                  <h4 style={{ color: '#002868', marginBottom: '15px' }}>¿Tienes dudas?</h4>
                  <p style={{ color: '#6b7280', fontSize: '0.95rem' }}>
                    Consulta nuestras preguntas frecuentes o agenda una cita personalizada
                  </p>
                </div>
              ...
              <div style={styles.governmentSeal}>
                <FontAwesomeIcon icon={faShieldAlt} style={{ fontSize: '2.5rem', color: '#002868', marginBottom: '15px' }} />
      ...
      <section style={{ 
        ...
        <div style={styles.container}>
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            <h3 style={{ fontSize: '2rem', color: '#002868', marginBottom: '20px' }}>
            ...
            {servicios.map((servicio, index) => (
              <div key={index} style={{ flex: '1', minWidth: '250px' }}>
                ...
                >
                  ...
                  />
                  <h6 style={{ color: '#002868', marginBottom: '10px' }}>{servicio.title}</h6>
                  <p style={{ color: '#6b7280', margin: 0, fontSize: '0.9rem' }}>
